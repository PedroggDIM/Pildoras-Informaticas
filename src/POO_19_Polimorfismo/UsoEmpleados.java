package POO_19_Polimorfismo;
import java.util.GregorianCalendar;
// Si creamos varias clases en un fichero solo una es la principal y será la public
public class UsoEmpleados {

	public static void main(String[] args) {
	// Gracias al PRINCIPIO  DE SUSTITUCIÓN puedo almacenar un objeto de tipo Jefe en
	// un objeto de tipo Empleados porque un Jefe es un Empleados // Jefe es subclase de Empleados
		...
		losEmpleados[4] =Juan;      //Un objeto de tipo Jefe lo almaceno en un array de tipo Empleado gracias 
		                            // al principio de sustitución (es un). 
		                            // Cuando el objeto Juan entra al for, aunque es un objeto de tipo Empleado,
		                            //cuando llega al getSueldo() se va al método de su clase no de empleado.
		                            // Para el objeto Jefes Juan no utiliza el getSueldo() de la clase Empleados, usa 
		                            //getSueldo() de la clase Jefes (ESTO ES EL POLIMORFISMO y se conoce también  
		                            // como enlazado dinámico
